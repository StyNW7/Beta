  ...
  return (
    <div className="container flex flex-col items-center justify-center min-h-[calc(100vh)] px-4 text-center">
      ...
      >
        ...
        >
          <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-4">Halaman Tidak Ditemukan</h1>
          <p className="text-muted-foreground mb-8">
            Tidak... Halaman yang anda cari tidak ditemukan. Silakan kembali ke menu utama
          </p>
        </motion.div>
